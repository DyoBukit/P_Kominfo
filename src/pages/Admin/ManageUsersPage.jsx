      ...
      <div className="relative z-10 flex-grow flex flex-col py-6"> 
        ...
        <main className="flex-grow p-8 md:p-12 max-w-6xl mx-auto w-full">
          ...
          >
            ...
            {/* InputField Username - Hapus div label manual */}
            <InputField
              ...
              // Kelas disesuaikan secara default oleh InputField (berkat perbaikan di InputField.jsx)
            />
            {/* InputField Email - Hapus div label manual */}
            <InputField
              label="Email" // Label sekarang dihandle oleh InputField
              type="email" // Pastikan type yang benar
              id="newEmail"
              value={newEmail}
              onChange={(e) => setNewEmail(e.target.value)}
              placeholder="e.g., john@example.com"
            />
            {/* InputField Password - Hapus div label manual */}
            <InputField
              label="Password" // Label sekarang dihandle oleh InputField
              type="password" // Pastikan type yang benar
              id="newPassword"
              value={newPassword}
            ...
            <div>
              ...
              <select
                ...
                // Gaya input field disesuaikan agar konsisten dengan InputField
